...
from Condition2Cure.entities.config_entity import DataIngestionConfig, DataValidationConfig, DataCleaningConfig, FeatureEngineeringConfig, ModelTrainerConfig, ModelEvaluationConfig
